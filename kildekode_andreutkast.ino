...
en fast maximum- og minimumsverdi beregnet utfra gjennomsnittet av 100 målinger. Funksjonen calibrate brukes til å hente
disse verdiene ved å vente til brukeren trykker på knappen for å så utføre de 100 målingene. Når den maksimale sensorverdien
skal kallibreres skal sensoren være helt tør, kun eksponert for luft. Når den minimale verdien skal kallibreres skal sensoren
være dyppet i vann. Når kallibreringen er utført starter overvåkingen av planten med basis i de registrerte maksimums- og minimumsverdiene.
*/
